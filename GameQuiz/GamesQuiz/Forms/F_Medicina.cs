...
namespace GamesQuiz.Forms
{
    public partial class F_Medicina : Form
    {
        ...
        private void F_Medicina_Load(object sender, EventArgs e)
        {
            QuestoesMedicina();
            cases();
        }
        ...
        private void btn_verificar_Click(object sender, EventArgs e)
        {
            if (rb_perguntaA.Checked || rb_perguntaB.Checked || rb_perguntaC.Checked || rb_perguntaD.Checked)
            {
                ...
                else
                {
                    ...
                    C_PerguntaDadosQuestoes metodoRetornaQuestaos = new C_PerguntaDadosQuestoes(passa);
        ...
        {
            this.Close();
           F_Medicina medicina = new F_Medicina(guardaNome);
            medicina.Show();
        }
        ...
        private void QuestoesMedicina()
        {
            C_PerguntaDadosQuestoes metodoRetornaQuestao = new C_PerguntaDadosQuestoes(passa);
