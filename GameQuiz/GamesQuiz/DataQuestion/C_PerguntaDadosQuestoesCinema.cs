...
{
    class C_PerguntaDadosQuestoesCinema
    {
        ...
        public C_PerguntaDadosQuestoesCinema(int recebeValorPergunta)
        {
            this.recebeValor = recebeValorPergunta;
        }

        public C_PerguntaDadosQuestoesCinema()
        {
            // recebeValor = 10;
        }
        public int QuestaoRodadaRetorna()
        {
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM Quiz_Cinema WHERE ID_PERGUNTA  = @ID";
