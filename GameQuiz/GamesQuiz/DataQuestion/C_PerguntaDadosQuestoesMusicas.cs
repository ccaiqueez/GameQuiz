...
{
    class C_PerguntaDadosQuestoesMusicas
    {
        ...
        public C_PerguntaDadosQuestoesMusicas(int recebeValorPergunta)
        {
            this.recebeValor = recebeValorPergunta;
        }

        public C_PerguntaDadosQuestoesMusicas()
        {
            // recebeValor = 10;
        }
        public int QuestaoRodadaRetorna()
        {
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM Quiz_Musica WHERE ID_PERGUNTA  = @ID";
